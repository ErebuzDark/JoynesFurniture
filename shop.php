...
<html lang="en">
    ...
    <head>
        ...
        <link type="image/png" sizes="16x16" rel="icon" href=".../icons8-wardrobe-ios11-16.png"> <meta name="msapplication-square70x70logo" content=".../icons8-wardrobe-ios11-70.png">
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <img width="40" height="40" src="https://img.icons8.com/ios-filled/50/737373/hammer.png" alt="hammer"/></a>
                    ...
                    <form method="POST" action="functions.php">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-8 text-end">
                                    <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text active" data-bs-toggle="pill" href="#tab-1"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/fluency-systems-filled/50/border-all.png" alt="chair"/><span>All Products</span>
                                                <span class="text-dark text-end me-3" style="width: 135px;">(<?php echo $all ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex py-2 m-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-2"><img class="me-2 ms-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/dressing-table.png" alt="dressing-table"/><span>Mirrors</span>
                                                <span class="text-dark text-end me-3" style="width: 170px;">(<?php echo $mir ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-3"><img class="me-2 ms-2" width="20" height="20" src="https://img.icons8.com/ios-glyphs/30/wardrobe.png" alt="wardrobe"/><span>Cabinets</span>
                                                <span class="text-dark text-end me-3" style="width: 160px;">(<?php echo $cab ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-4"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/chair.png" alt="chair"/><span>Chairs</span>
                                                <span class="text-dark text-end me-3" style="width: 180px;">(<?php echo $ch ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-5"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/table.png" alt="table"/><span>Tables</span>
                                                <span class="text-dark text-end me-3" style="width: 180px;">(<?php echo $tab ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-6"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/bed.png" alt="chair"/><span>Bedframe</span>
                                                <span class="text-dark text-end me-3" style="width: 155px;">(<?php echo $bed ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-7"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/restaurant-table.png" alt="chair"/><span>Sala Set</span>
                                                <span class="text-dark text-end me-3" style="width: 170px;">(<?php echo $sala ?>)</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="d-flex m-2 py-2 rounded-pill nav-text" data-bs-toggle="pill" href="#tab-8"><img class="ms-2 me-2" width="20" height="20" src="https://img.icons8.com/ios-filled/50/tv.png" alt="chair"/><span>Tv Stand</span>
                                                <span class="text-dark text-end me-3" style="width: 163px;">(<?php echo $tvs ?>)</span>
                                            </a>
                                        </li>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-4 mt-5 ">
                                                    <div class="rounded position-relative fruite-item border fia" data-image="./up/<?php echo $row['image']; ?>" data-name="<?php echo $row['fName']; ?>" data-cost="&#8369;<?php echo $cost; ?>" data-count="<?php echo $totSold; ?>" data-des="<?php echo $row['fDes']; ?>">

                                                    <form method="POST" action="functions.php">
                                                        <div class="fruite-img">
                                                            <a href="shop-detail.php?id=<?php echo $row['fID']; ?>">
                                                                <img src="./up/<?php echo $row['image']; ?>" class="img-fluid w-100 rounded-top" alt="" ></a>
                                                        ...
                                                        if ($row['date'] >= $one_week_ago) { ?>
                                                            <div class="text-white bg-danger px-2 py-2 rounded-pill position-absolute" style="top: 10px; right: 10px;">New!</div>          
                                                        <?php } ?>

                                                        <?php 
                                                        if ($totSold >= 10) { ?>
                                                            <div class="text-white bg-danger px-2 py-2 rounded-pill position-absolute" style="top: 10px; right: 10px;">Hot!</div>          
                                                        <?php } ?>
                                                        ...
                                                        <div class="p-4 rounded-bottom">
                                                            ...
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                            <button type="submit" class=" btn border border-secondary rounded-pill px-2 text-primary mt-4" name="add"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add to cart</button>

                                                            <input type="hidden" value="<?php echo $row['fID']; ?>" name="id">

                                                            <input type="hidden" value="1" name="quantity">

                                                            <a data-id='<?php echo $row['fID']; ?>' type="submit" class="btn check border d-flex align-items-center border-secondary rounded-pill px-2 text-primary mt-4" name="check" value="<?php echo $row['fQuantity']; ?>"><i class="fa fa-shopping-bag me-2"></i>Check Out</a>
                                                            </div>
                                                        </div>
                                                      </form>
                                                    </div>
                                            ...
                                            <div class="page-numbers d-flex justify-content-center">
                                                <?php
                                                    for ($counter = 1; $counter <=$pages ; $counter ++) { 
                                                        ?>
                                                        <a href="?page-nr=<?php echo $counter ?>" class="rounded"><?php echo $counter ?></a>
                                                        <?php
                                                    }
                                ...
                                <div id="detail-box" class="rounded border p-3 bg-light shadow" style="display: none; position: absolute; z-index: 1000;">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <p class="mt-2 mb-0 mx-3" style="font-size:12px;">(<span id="detail-count"></span> sold)</p>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="rounded position-relative fruite-item border">
                                            ...
                                            <div class="p-4 rounded-bottom">
                                                ...
                                                <input type="hidden" value="<?php echo $row['fID']; ?>" name="id">
                                                <input type="hidden" value="1" name="quantity">
                                                <button data-id='<?php echo $row['fID']; ?>' 
                                                 type="button" class="btn check border d-flex align-items-center border-secondary rounded-pill px-2 text-primary mt-4" name="check"><i class="fa fa-shopping-bag me-2"></i>Check Out</button>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="rounded position-relative fruite-item border">
                                                        ...
                                                        <div class="p-4 rounded-bottom">
                                                            ...
                                                            <a data-id='<?php echo $row['fID']; ?>' 
                                                             type="submit" class="btn check border d-flex align-items-center border-secondary rounded-pill px-2 text-primary mt-4" name="check"><i class="fa fa-shopping-bag me-2"></i>Check Out</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </form>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-4">typesetting, remaining essentially unchanged. It was 
                                popularised in the 1960s with the like Aldus PageMaker including of Lorem Ipsum.typesetting, remaining essentially unchanged. It was 
