...
$sql1 = "SELECT quantity FROM addcart WHERE userID = ?";
...
$totf = $row5['SUM(cost)'];
$formattedtotf = number_format($totf, 0, '.', ',');
$tot = $formattedtotf;
    ...
    <!-- <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><img class="logo" src="./img/logo1.png" alt="Bootstrap" style="width: 200px"></a>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
                ...
                <table class="table">
                    ...
                    while ($row = mysqli_fetch_assoc($resultu)) {
                        ...
                        <tbody>
                            ...
                            <td>
                                <p class="mb-0 mt-4">&#8369;<?php echo $cost1; ?></p>
                            </td>
                            <td>
            ...
            <div class="row g-4 justify-content-start bg-light">
                <div class="col-8">
                    <button data-id='<?php echo $row5['ID']; ?>'
                        class="btn proc border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
                        type="button">Proceed Checkout</button>
                </div>
                <div class="col-3">
                    <p class=" fw-bolder px-4 py-3 text-primary text-uppercase mb-4 ms-4" style="font-size: 21px;"><span
                            style="margin-right: 10px;">Total:</span> &#8369;<?php echo $tot; ?></p>
                </div>
            </div>
        </div>
    </div>
